...
document.getElementById("gameTroll").addEventListener("click", function(event) {
	...
	document.getElementById('a').addEventListener("click", function(event) {
		document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>No Flashlight.<br>It's getting warmer.<br>It's getting louder.<br>Do you...</p>";
		NextDecision("A. Follow the noise?","B. Walk forward?");
		document.getElementById('a').addEventListener("click", function(event) {
			document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>It's hot.<br>It's breathing down your neck.<br>It got you.</p>";
		});
		document.getElementById('b').addEventListener("click", function(event) {
			document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>There's a door.<br>The door is locked.<br>It's Hot.<br>Do you...</p>";
                	NextDecision("A. Call for help?","B. Bang on the door?");
			document.getElementById('a').addEventListener("click", function(event) {
				document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>Nobody heard.<br>It covers your mouth.<br>It got you.</p>";
			});
			 document.getElementById('b').addEventListener("click", function(event) {
				 document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>It's loud.<br>It's breathing down your neck.<br>It got you.</p>";
			});
		});
	});
	document.getElementById('b').addEventListener("click",function(event) {
		document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>There's a door.<br>The door is locked.<br>It's getting warmer.<br>Do you...</p>";
                NextDecision("A. Check to the left for a key?","B. Bang on the door?");
		document.getElementById('a').addEventListener("click", function(event) {
			document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>It's hot.<br>It's breathing down your neck.<br>There's a key on the floor.<br>Do you...</p>";
                	NextDecision("A. Unlock the door?","B. Turn around?");
			document.getElementById('a').addEventListener("click", function(event) {
				document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>You run out into a bright open field.<br>You let out a sigh of relief.<br>You are free.<br>But so is the It.</p>"
			});
			document.getElementById('b').addEventListener("click", function(event) {
                                document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>It's horrifying.<br>You stab it with the key.<br>It screeches.<br>Your ears bleed.<br>It got you.</p>"
			});
		});
		document.getElementById('b').addEventListener("click", function(event) {
			document.querySelector(".books-grid .game-box .gameEvents").innerHTML = "<p>It's loud.<br>It's breathing down your neck.<br>It got you.</p>";
